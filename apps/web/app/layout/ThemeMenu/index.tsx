...
export const ThemeMenu = ({
  ...
  useEffect(() => {
    ...
    // 检测字体颜色是否清晰
    setColorTips({
      upColor: isTextReadable(bgColor, hex2rgbArray(themeSetting.upColor), 3)
        ? undefined
        : "当前颜色对比度过低，建议调整",
      downColor: isTextReadable(
        bgColor,
        hex2rgbArray(themeSetting.downColor),
        3
      )
        ? undefined
        : "当前颜色对比度过低，建议调整"
    ...
    >
      <Box>
        ...
        <Radio.Group
          ...
          onChange={value =>
            _setTheme("colorScheme", value as MantineColorScheme)
          }
        >
          <Group>
